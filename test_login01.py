...
screenshot_folder = "screenshots/login01"
...
def test_login01_pos01(page: Page):
    try:
        ...
        screenshot_path = os.path.join(screenshot_folder, "test_login01_pos01.png")
        page.screenshot(path=screenshot_path)
        copied_text = page.locator("text=ยืนยันรหัสผ่านใหม่").text_content()
        update_excel("test_login01_pos01", "passed", screenshot_path, copied_text)
    except Exception as e:
        print(f"Test failed: {e}")
        screenshot_path = os.path.join(screenshot_folder, "test_login01_pos01_failed.png")
        page.screenshot(path=screenshot_path)
        update_excel("test_login01_pos01", "failed", screenshot_path)
...
def test_login01_neg01(page: Page):
    try:
        ...
        # บันทึกภาพหน้าจอเมื่อผ่านการทดสอบ
        screenshot_path = os.path.join(screenshot_folder, "test_login01_neg01.png")
        page.screenshot(path=screenshot_path)
        update_excel("test_login01_neg01", "passed", screenshot_path)
    except Exception as e:
        print(f"Test failed: {e}")
        screenshot_path = os.path.join(screenshot_folder, "test_login01_neg01_failed.png")
        page.screenshot(path=screenshot_path)
        update_excel("test_login01_neg01", "failed", screenshot_path)
...
def test_login01_neg02(page: Page):
    try:
        ...
        # บันทึกภาพหน้าจอเมื่อผ่านการทดสอบ
        screenshot_path = os.path.join(screenshot_folder, "test_login01_neg02.png")
        page.screenshot(path=screenshot_path)
        update_excel("test_login01_neg02", "passed", screenshot_path)
    except Exception as e:
        print(f"Test failed: {e}")
        screenshot_path = os.path.join(screenshot_folder, "test_login01_neg02_failed.png")
        page.screenshot(path=screenshot_path)
        update_excel("test_login01_neg02", "failed", screenshot_path)
...
def test_login01_neg03(page: Page):
    try:
        ...
        # บันทึกภาพหน้าจอเมื่อผ่านการทดสอบ
        screenshot_path = os.path.join(screenshot_folder, "test_login01_neg03.png")
        page.screenshot(path=screenshot_path)
        update_excel("test_login01_neg03", "passed", screenshot_path)
    except Exception as e:
        print(f"Test failed: {e}")
        screenshot_path = os.path.join(screenshot_folder, "test_login01_neg03_failed.png")
        page.screenshot(path=screenshot_path)
        update_excel("test_login01_neg03", "failed", screenshot_path)
